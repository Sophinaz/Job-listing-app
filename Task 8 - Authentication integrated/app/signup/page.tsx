        ...
        <div className='mt-10 w-5/12 bg-slate-40'>
            ...
            <div className='flex w-full flex-col space-y-6 items-center'>
                ...
                <div className='flex w-9/12 justify-center space-x-3 border border-[#CCCCF5] py-2'>
                    ...
                    <h3 className=' text-[#4640DE] font-epilogue font-bold text-lg'>sign up with google</h3>
                </div>
                </Link>

                <div>
                    <h3 className='font-light font-epilogue text-[#202430]'>Or Sign Up with Email</h3>
                </div>
            </div>
            ...
            <div className='w-full flex justify-center'>
                ...
                <form onSubmit={(e) => e.preventDefault()} className='mb-3 mt-5 w-3/4 flex flex-col space-y-5' action="">
                    ...
                    <div>
                        <button onClick={handleSubmit(onSubmit)} className='w-full py-4 rounded-full bg-indigo-900 text-white font-epilogue'>continue</button>
                    </div>
